    ...
    <div class="card-body">
        ...
        <form action="/produk" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="kode_barang" name="kode_barang" required autofocus value="{{ old('kode_barang') }}">
                  @error('kode_barang')
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_barang" name="nama_barang" required autofocus value="{{ old('nama_barang') }}">
                  @error('nama_barang')
                      <div class="invalid-feedback">
                          {{ $message }}
                      </div>
